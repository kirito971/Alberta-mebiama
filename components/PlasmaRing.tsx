...
// Recolored for Alberta Mebiama's terracotta/kraft palette (was a generic
// red/blue/purple default). Logic and shaders are otherwise unchanged.
"use client"
...
const MAX_COLORS = 5
// Brand palette — light peach through terracotta to deep terracotta.
const DEFAULT_COLORS = ["#C97C54", "#8F4E30"]
...
export default function PlasmaRing(props: Props) {
    ...
    const [hoverMV] = useState(() => motionValue(0))
